...
public Map<String, Object> toMap() {
	Map<String,Object> map = new HashMap<String,Object>();
        map.put("id",this.id);
        map.put("productionOrderNumber",this.productionOrderNumber);
        map.put("productId",this.productId);
        map.put("productionQuantity",this.productionQuantity);
        map.put("productionStartDate",this.productionStartDate);
        map.put("plannedCompletionDate",this.plannedCompletionDate);
        map.put("actualCompletionDate",this.actualCompletionDate);
        map.put("processId",this.processId);
        map.put("operationId",this.operationId);
        map.put("inspectionInfoId",this.inspectionInfoId);
        map.put("workShift",this.workShift);
        map.put("productionStatus",this.productionStatus);
        map.put("qualityInspection",this.qualityInspection);
