...
@Data
public class OperationInfoVo implements Serializable {
...
public Map<String, Object> toMap() {
	Map<String,Object> map = new HashMap<String,Object>();
        ...
        map.put("operationName",this.operationName);
        map.put("standardTime",this.standardTime);
        map.put("actualTime",this.actualTime);
        map.put("responsiblePerson",this.responsiblePerson);
        map.put("equipmentNeeded",this.equipmentNeeded);
        map.put("personnelInvolved",this.personnelInvolved);
        map.put("qualityInspection",this.qualityInspection);
        map.put("operationStatus",this.operationStatus);
