...
@Data
public class InventoryTableVo implements Serializable {
...
public Map<String, Object> toMap() {
	Map<String,Object> map = new HashMap<String,Object>();
        map.put("id",this.id);
        map.put("inventoryId",this.inventoryId);
        map.put("inventoryName",this.inventoryName);
        map.put("materialId",this.materialId);
        map.put("warehouseId",this.warehouseId);
        map.put("inOrderId",this.inOrderId);
        map.put("outOrderId",this.outOrderId);
        map.put("inDate",this.inDate);
        map.put("outDate",this.outDate);
        map.put("inQuantity",this.inQuantity);
        map.put("outQuantity",this.outQuantity);
        map.put("inPrice",this.inPrice);
        map.put("outPrice",this.outPrice);
        map.put("maxStock",this.maxStock);
        map.put("safeStock",this.safeStock);
        map.put("remainingStock",this.remainingStock);
