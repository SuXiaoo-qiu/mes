...
public Map<String, Object> toMap() {
	Map<String,Object> map = new HashMap<String,Object>();
        ...
        map.put("primaryContactName",this.primaryContactName);
        map.put("primaryContactInfo",this.primaryContactInfo);
        map.put("customerStatus",this.customerStatus);
        map.put("creditTerms",this.creditTerms);
        map.put("paymentHistory",this.paymentHistory);
        map.put("salesRepresentative",this.salesRepresentative);
    	return map;
}
