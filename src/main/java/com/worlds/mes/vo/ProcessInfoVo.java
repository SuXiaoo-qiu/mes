...
public Map<String, Object> toMap() {
	Map<String,Object> map = new HashMap<String,Object>();
        ...
        map.put("processVersion",this.processVersion);
        map.put("processType",this.processType);
        map.put("applicableProduct",this.applicableProduct);
        map.put("processStatus",this.processStatus);
        map.put("processFlow",this.processFlow);
        map.put("processFile",this.processFile);
