...
public class MesEnumUtils {
    ...
    public static final Integer CODE_200 = 200;  //200:OK
    public static final Integer CODE_400 = 400;  //400:错误的请求
    public static final Integer CODE_401 = 401;  //401:未经授权
    public static final Integer CODE_403 = 403;  //403:被禁止的
    public static final Integer CODE_404 = 404;  //404:未找到
    public static final Integer CODE_500 = 500;  //500:内部服务器错误
